...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/evangelos-vlachos-software-engineer)
[![YouTube](https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://www.youtube.com/@evangelosvlachos1827)
...
Senior Software Engineer with **7+ years** of experience designing, building, and modernizing backend and full-stack systems across **banking, EV charging, telecommunications, and SaaS** domains.

Currently applying that engineering depth to **frontier AI development**: evaluating agentic coding systems for correctness, security, and behavioral reliability at [Labelbox](https://labelbox.com) (US).

**My Superpowers:**
- 🏗️ **Architecture**: Domain-Driven Design, Microservices, Event-Driven systems, Monolith-to-Microservices refactoring.
...
I'm active across multiple platforms where I share knowledge, take on freelance projects, and contribute to the developer community:

| Platform | What I do there |
|----------|----------------|
| **[Upwork](https://www.upwork.com/freelancers/~01401197e2b19c9b73)** | Freelance software engineering & architecture gigs |
...
|----------|--------------|
| **Languages** | C#, .NET 5/6/10, TypeScript, JavaScript, Python, Go, Java |
| **Frontend** | Angular 10/11, Blazor Server, Razor Pages, MudBlazor |
| **Architecture** | DDD, CQRS, Event-Driven, REST, gRPC, SOAP |
| **Cloud** | Azure (Fundamentals certified), AWS basics, OpenShift |
| **Messaging** | Apache Kafka, Azure Service Bus, Pub/Sub patterns |
| **Databases** | PostgreSQL, SQL Server, Cosmos DB, Entity Framework Core |
| **DevOps** | Azure DevOps, Docker, CI/CD, SonarCloud, Quality Gates |
| **Monitoring** | Application Insights, Grafana, Prometheus, Dynatrace, Better Stack |
| **AI/ML** | Python, TensorFlow, scikit-learn, Google Colab, Model Evaluation Rubrics |
...
### [Clean Architecture .NET](https://github.com/evangelosvlachos96-dotcom/clean-architecture-dotnet)
A modern Clean Architecture template for .NET 8+ applications. Built with Domain-Driven Design (DDD), CQRS, and testability in mind.

*(More projects being upgraded and added soon!)*
...
⭐ **If you find any of my projects useful, consider giving them a star!** It helps me know what the community values.
